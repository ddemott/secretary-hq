...
| **Tests**     | Root `npm test` green: 3,147 passing (263 files). Dashboard 1,126 (104 files) + agent 1,048 (61 files) green. See `docs/planning/TEST_COVERAGE.md` for coverage detail.                                                                                                                                                                                               |
