...
| **Tests**     | Root `npm test` green: 3,194 passing (267 files). Dashboard 1,138 (104 files) + agent 1,061 (61 files) green. See `docs/planning/TEST_COVERAGE.md` for coverage detail.                                                                                                                                                                                               |
